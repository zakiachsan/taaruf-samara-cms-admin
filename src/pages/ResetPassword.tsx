// Password reset page - User is already verified by Supabase before landing here
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 mb-6">
            Password berhasil direset! Silakan buka aplikasi Taaruf Samara dan login dengan password baru Anda.
          </p>
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-4">
            <p className="text-sm text-emerald-800">
              <strong>Selanjutnya:</strong> Buka aplikasi Taaruf Samara dan login dengan password baru Anda.
            </p>
          </div>
